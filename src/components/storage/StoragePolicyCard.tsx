...
function TencentBg() {
  return (
    <svg viewBox="0 0 1402 1024" xmlns="http://www.w3.org/2000/svg" className="absolute -right-6 -top-4 h-32 w-auto opacity-[0.12] dark:opacity-[0.08]" aria-hidden="true">
...
function LocalBg() {
  return (
    <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute -right-2 -top-2 h-24 w-auto opacity-[0.15] dark:opacity-[0.10]" aria-hidden="true">
...
export function StoragePolicyCard({ bucket, onEdit, onDelete, onSync, syncing }: StoragePolicyCardProps) {
  ...
  return (
    <div className={cn("group relative flex flex-col overflow-hidden rounded-2xl bg-muted/40 transition-all hover:bg-muted/60")}>
      {isLocal ? <LocalBg /> : <TencentBg />}
